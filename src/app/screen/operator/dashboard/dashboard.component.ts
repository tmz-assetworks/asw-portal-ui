  ...
  initMap() {
    ...
    const map = new google.maps.Map(document.getElementById('map'), {
      ...
      for (const data of this.mapstatusdata) {
        ...
        const finalLatLng = new google.maps.LatLng(
        ...
        const contentString =
            '<p><b style="color:blue">' + data.chargeBoxid +
            '</b><br/>Asset ID: ' + data.assetId +
        ...
        marker.addListener('click', () => {
          this._storageService.setSessionData('chargerBoxId', data.chargeBoxid)
          this._storageService.setSessionData('chargerName', data.chargeBoxid);
