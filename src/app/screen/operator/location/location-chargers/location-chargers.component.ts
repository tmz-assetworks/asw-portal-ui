...
export class LocationChargersComponent implements OnInit {
  locationChargerList=[]
   ...
   constructor(public _locationService: LocationService,private _auth: AuthService){
...
getLocationList(){
  ...
  this._locationService.locationChargerList().subscribe(data=>{
   this.locationChargerList=data.Data
   console.log(this.locationChargerList, "Hiiiiiii");
  ...
  //   this.dataSource.paginator = this.paginator;
  // }
  displayedColumns: string[] = ['chargerid', 'chargername', 'chargermake','chargermodel', 'connectortype','ocppprotocol','chargerstatus','chargerports','action'];
