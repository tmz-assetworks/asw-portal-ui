...
export class ManageAdminUsersComponent implements OnInit {
  ...
  constructor(public _superAdminService: SuperAdminService, private _router: Router){
  ...
  displayedColumns: string[] = ['CustomerName', 'AdminName', 'EmailId', 'Country','Status','Action'];
  ...
  getAdminList(){
    ...
    this._superAdminService.adminList().subscribe((data)=>{
      this.adminList=data.Data
        console.log(this.adminList,"Marvel--->>");
