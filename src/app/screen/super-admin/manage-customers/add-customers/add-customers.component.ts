...
*/
  ...
  getAllCountry() {
    this.superadminService.getAllCountry().subscribe((res: any) => {
  ...
  getAllStateByCountryId(id: any) {
    this.superadminService.getAllStateByCountryId(id).subscribe((res: any) => {
  ...
  //   this.superadminService.getAllCityByStateId(id).subscribe((res: any) => {
