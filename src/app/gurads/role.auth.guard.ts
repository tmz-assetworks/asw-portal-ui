...
export class RoleAuthGuard implements CanActivate {
  constructor(private _router: Router, public activatedRoute: ActivatedRoute,private _authService: AuthService) {}
   canActivate() {
    ...
    //alert(getRole + 'vvav');
    if(getRole !== '' && routePath.indexOf(getRole.toLowerCase()) !== -1 && this._authService.haveAccess(getRole)) {
    return true
